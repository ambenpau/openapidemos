...
{
    // Recuperamos el recurso correspondiente al numero de celda
...
{
    // Iniciem la vista del recurs seleccionat.
...
- (void)cargarRecursos
{
    ...
    // Definim la URL que ens dona les dades dels recursos de l'aula actual.
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/resources?access_token=%@", self.aula.identifier, self.auth.accessToken]];
