...
-(void) carregarFolder{
    ...
    NSURL *folderURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/inbox?access_token=%@", self.auth.accessToken]];
