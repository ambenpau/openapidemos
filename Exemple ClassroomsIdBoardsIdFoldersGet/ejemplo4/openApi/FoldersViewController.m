...
{
    [super viewDidLoad];
    // Els arrays cal inicialitzar-los sempre.
...
{
    // Iniciem la vista de folder amb els valors de la folder seleccionada
...
- (void)cargarFolders
{
    ...
    //Definim la URL per a obtenir les dades dels folders dels boards, indiquem l'aula i el tauler on estem
