...
-(void)obtenirCurrentProfile
{
    ...
    NSURL *profilesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/user/profiles/current?access_token=%@", self.auth.accessToken]];
...
-(IBAction)putCurrentProfile
{
    ...
    NSURL *profileURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/user/profiles/current?access_token=%@", self.auth.accessToken]];
