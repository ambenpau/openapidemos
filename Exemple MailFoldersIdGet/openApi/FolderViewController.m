...
- (void) carregarFolder
{
    ...
    NSURL *folderURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/%@?access_token=%@",  self.idFolder, self.auth.accessToken]];
