...
- (void) carregarMaterial
{
    ...
    NSURL *matURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/materials/%@?access_token=%@", self.aula.identifier, self.idMat, self.auth.accessToken]];
