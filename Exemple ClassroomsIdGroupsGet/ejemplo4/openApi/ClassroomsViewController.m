...
{
    // Iniciem la vista dels grups de l'aula seleccionada.
    GroupsViewController *groupsViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"groupsView"];
    groupsViewController.auth = self.auth;
    groupsViewController.aula = [self.classrooms objectAtIndex:indexPath.row];
