...
- (void)cargarGrups
{
    ...
    NSURL *groupsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/groups?access_token=%@", self.aula.identifier, self.auth.accessToken]];
