...
- (void)cargarSettings
{
    ...
    NSURL *settingsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/user/settings?access_token=%@", self.auth.accessToken]];
