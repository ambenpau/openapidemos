...
{
    // Iniciem la vista que ens mostrara el recurs seleccionat.
...
- (void)cargarRecursos
{
    ...
    // Definim la URL que ens donara les dades dels recursos de l'aula.
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/resources?access_token=%@", self.aula.identifier, self.auth.accessToken]];
