...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MailsViewController *mailsViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"mailsView"];
    mailsViewController.folder = [self.folders objectAtIndex:indexPath.row];
    mailsViewController.tauler = self.board;
    mailsViewController.aula = self.aula;
    mailsViewController.auth = self.auth;
