...
{
    // Iniciem la vista que carrega el mail. Passem l'identificador del mail que volem carregar,
    // l'autenticacio, l'aula i el tauler on estem.
    ...
    mailViewController.tauler = self.tauler;
