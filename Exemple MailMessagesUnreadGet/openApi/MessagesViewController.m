...
{
    // Iniciem la vista que mostra el missatge seleccionat.
...
- (void)cargarMessages
{
    ...
    // Definim la URL per obtenir les dades de unread.
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/messages/unread?access_token=%@", self.auth.accessToken]];
