...
{
    // Iniciem la vista per veure el body del missatge seleccionat.
    MessageBodyViewController *messageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"bodyView"];
