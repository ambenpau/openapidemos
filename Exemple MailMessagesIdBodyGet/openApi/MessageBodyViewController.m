...
- (void) carregaMessage
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/messages/%@/body?access_token=%@", self.idMessage ,self.auth.accessToken]];
