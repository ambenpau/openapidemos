...
{
    // Iniciem la vista de la carpeta on carregarem els valors d'aquesta.
    // En aquella vista necessitarem l'autenticacio, l'aula, el tauler i l'identificador de la carpeta.
    ...
    folderViewController.board = self.board;
