...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Passem a la vista d'event l'identificador de l'event que voldrem carregar.
    eventViewController.identificadorEvent = [[self.events objectAtIndex:indexPath.row] identifier];
    eventViewController.auth = self.auth;
