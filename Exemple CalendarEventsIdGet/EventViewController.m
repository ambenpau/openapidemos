...
-(void)carregarEvent
{
    ...
    NSURL *eventsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/calendar/events/%@?access_token=%@", self.identificadorEvent ,self.auth.accessToken]];
