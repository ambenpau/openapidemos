...
- (void)carregarMessages
{
    ...
    // Definim la URL que ens donara les dades dels missatges unread.
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/boards/%@/messages/unread?access_token=%@",self.aula.identifier, self.board.identifier, self.auth.accessToken]];
