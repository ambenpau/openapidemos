...
{
    // Recuperamos el profesor correspondiente al numero de celda
...
{
    // Iniciem la vista que ens mostrara el professor seleccionat
...
- (void)cargarPeople
{
    ...
    // Definim la URL que ens mostra els professors de l'aula.
    NSURL *estURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/people/teachers?access_token=%@", self.aula.identifier, self.auth.accessToken]];
