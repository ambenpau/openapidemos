...
{
    // Iniciem la vista que ens carregara i mostara el missatge seleccionat.
...
- (void)carregarMessages
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/boards/%@/messages?access_token=%@",self.aula.identifier, self.board.identifier, self.auth.accessToken]];
