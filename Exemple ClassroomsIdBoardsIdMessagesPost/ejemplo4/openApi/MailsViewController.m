...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    mailViewController.mainURL = [NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/messages",self.aula.identifier, self.tauler.identifier];
...
- (void)cargarMails
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/messages?access_token=%@",self.aula.identifier, self.tauler.identifier, self.auth.accessToken]];
