...
-(IBAction)newMessage{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/messages?access_token=%@", self.auth.accessToken]];
