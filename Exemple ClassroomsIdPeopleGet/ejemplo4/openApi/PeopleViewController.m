...
- (void)cargarPeople
{
    ...
    NSURL *estURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/people?access_token=%@", self.aula.identifier, self.auth.accessToken]];
