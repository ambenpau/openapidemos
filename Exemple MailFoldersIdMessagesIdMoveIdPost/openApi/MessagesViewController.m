...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    messageViewController.folder = self.folder;
...
- (void)cargarMessages
{
    ...
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/%@/messages?access_token=%@", self.folder.identifier, self.auth.accessToken]];
