...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/%@/messages/%@/move/%@?access_token=%@", self.sourceFolder.identifier, self.message.identifier , folder.identifier , self.auth.accessToken]];
...
- (void)cargarFolders
{
    ...
    NSURL *foldersURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders?access_token=%@",  self.auth.accessToken]];
