...
-(void) carregarRecurs
{
    ...
    NSURL *resourcesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/resources/%@?access_token=%@", self.aula.identifier, self.idRecurs, self.auth.accessToken]];
