...
{
    // Iniciem la vista que ens mostrara el tutor seleccionat.
...
- (void)cargarTutors
{
    ...
    // Definim la URL que ens donara la tutorList.
    NSURL *tutorsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/user/tutors?access_token=%@", self.auth.accessToken]];
