...
-(void) carregarSubject
{
    ...
    NSURL *classroomsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@?access_token=%@", self.idAula, self.auth.accessToken]];
