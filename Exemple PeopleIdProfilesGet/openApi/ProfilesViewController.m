...
- (void)cargarPerfils
{
    ...
    NSURL *profilesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/people/%@/profiles?access_token=%@", self.person.identifier, self.auth.accessToken]];
