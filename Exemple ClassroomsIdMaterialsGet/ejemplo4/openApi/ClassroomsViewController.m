...
{
    // Iniciem la vista dels materials de l'aula seleccionada.
    MaterialsViewController *materialsViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"materialsView"];
    materialsViewController.auth = self.auth;
    materialsViewController.aula = [self.classrooms objectAtIndex:indexPath.row];
