...
-(void)carregaBoard
{
    ...
    NSURL *boardURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/subjects/%@/boards/%@?access_token=%@", self.aula.identifier, self.idBoard, self.auth.accessToken]];
