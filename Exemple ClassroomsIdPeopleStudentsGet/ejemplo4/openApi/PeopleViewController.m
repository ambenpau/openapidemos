...
{
    // Recuperamos el estudiante correspondiente al numero de celda
...
{
    // Iniciem la vista que ens mostra l'estudiant seleccionat.
...
- (void)cargarPeople
{
    ...
    // Definim la URL que ens dona les dades dels estudiants de l'aula.
    NSURL *estURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/people/students?access_token=%@", self.aula.identifier, self.auth.accessToken]];
