...
{
    // Iniciem la vista que ens mostrara i obtindra les dades del missatge seleccionat.
    MessageViewController *mesViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"messageView"];
    mesViewController.idMes = [[self.messages objectAtIndex:indexPath.row] identifier];
