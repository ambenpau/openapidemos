...
-(void) carregarFolder
{
    ...
    // Definim la URL que ens carrega les dades de la folder amb identificador idFolder.
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/classrooms/%@/boards/%@/folders/%@?access_token=%@", self.aula.identifier, self.board.identifier, self.idFolder, self.auth.accessToken]];
