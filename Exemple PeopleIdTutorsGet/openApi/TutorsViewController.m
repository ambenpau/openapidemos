...
- (void)cargarTutors
{
    ...
    NSURL *tutorsURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/people/%@/tutors?access_token=%@", self.person.identifier, self.auth.accessToken]];
