...
- (void)cargarMessages
{
    ...
    // Definim la URL que ens dona les dades dels missatges unread.
    NSURL *messagesURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/mail/folders/%@/messages/unread?access_token=%@", self.folder.identifier, self.auth.accessToken]];
    ...
    dispatch_async(backgroundQueue, ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            // Les modificacions a la vista nomes es poden fer a la cua principal.
