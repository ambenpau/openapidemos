...
{
    // Iniciem la vista que ens mostrara l'aula seleccionada.
    SubjectViewController *classroomViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"subjectView"];
    classroomViewController.aula = [self.classrooms objectAtIndex:indexPath.row];
...
- (void)cargarAulas
{
    ...
    // Definim la URL que ens donara la classroomList.
