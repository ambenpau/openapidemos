...
- (void)carregarPeople
{
    ...
    NSURL *peopleURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://denver.uoc.es:8080/webapps/uocapi/api/v1/people/%@?access_token=%@", self.idPeople, self.auth.accessToken]];
